...
@section('content')
                ...
                <div class="lg:col-span-2">
                    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-8 min-h-[500px]">
                        ...
                        <div class="mb-6">
                            ...
                            <input type="hidden" name="categories_input" id="hiddenCategories"
                                value="{{ old('categories_input') }}">
                        ...
                        <div class="w-full">
                            <textarea name="description" id="editor"
                                ...
                                placeholder="Mulailah menulis cerita Anda di sini..." required>{{ old('description') }}</textarea>
                        </div>
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-5">
                        ...
                        <div class="relative group">
                            <div id="image-preview"
                                class="hidden aspect-video w-full rounded-lg bg-gray-100 bg-center bg-cover border border-gray-200 mb-3 relative overflow-hidden">
                            ...
                            <label for="thumbnail-upload" id="upload-box"
                                ...
                                <div class="flex flex-col items-center justify-center pt-5 pb-6">
                                    ...
                                    <p class="mb-2 text-sm text-gray-500"><span class="font-semibold">Klik upload</span>
                                        atau drag & drop</p>
    ...
    <script>
        ...
        // Init: Load tags from hidden input (jika old data ada karena validasi error)
