...
<tr>
    <td class="header" style="background-color: #263C8F; text-align: center; padding: 30px 0;">
        <a href="{{ $url }}" style="display: inline-block; text-decoration: none; text-align: center;">
            {{-- Logo --}}
            <img src="{{ $message->embed(public_path('images/logo-isc-email.png')) }}" alt="{{ config('app.name') }} Logo"
                width="80" height="80"
                style="display:block; border-radius:50%; margin:0 auto 10px; object-fit:cover;">
