...
<head>
    ...
    <title>Atur Ulang Kata Sandi - Informatics Study Club</title>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="mb-4 text-center">
                            Masukkan email dan kata sandi baru Anda di bawah ini untuk mengganti password akun Anda.
                        </p>
                        ...
                        <form id="formAuthentication" method="POST" action="{{ route('password.store') }}">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="email" id="email"
                                    ...
                                    value="{{ old('email', $request->email) }}" placeholder="Masukkan email Anda"
                                    required autofocus />
                                @error('email')
                            ...
                            <div class="mb-3 form-password-toggle">
                                ...
                                <div class="input-group input-group-merge">
                                    <input type="password" id="password_confirmation"
                                        ...
                                        name="password_confirmation" placeholder="Ulangi kata sandi baru" required />
                                    <span class="input-group-text cursor-pointer"><i class="bx bx-hide"></i></span>
                                </div>
