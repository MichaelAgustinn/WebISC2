            ...
            <div class="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div>
                    ...
                    <p class="text-gray-500 mt-1">
                        Perbarui informasi event dengan mudah.
                    </p>
                </div>
            ...
            <div class="bg-white/90 backdrop-blur-lg rounded-3xl shadow-xl border border-gray-100 overflow-hidden">
                ...
                <div class="bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-500 px-6 py-8 text-white">
                    ...
                    <p class="text-indigo-100 mt-1">
                        Ubah data event sesuai kebutuhan.
                    </p>
                </div>

                {{-- Form --}}
                <div class="p-6 sm:p-8">
                    <form action="{{ route('admin-events.update', ['admin_event' => $event->id]) }}" method="POST"
                        ...
                        @if ($event->photo)
                            <div>
                                ...
                                <div class="relative overflow-hidden rounded-3xl border border-gray-200 shadow-md">
                                    <img src="{{ asset($event->photo) }}" alt="Poster Event"
                            ...
                            <label for="file-upload"
                                ...
                                <div id="preview-container" class="hidden mt-4">
                                    ...
                                    <img id="preview-image"
                                        class="w-full max-h-[350px] object-cover rounded-2xl border border-gray-200 shadow">
                                </div>
                            </label>
