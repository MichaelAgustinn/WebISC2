                    ...
                    <div class="mt-8 border-t border-gray-100 pt-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                            <div>
                                ...
                                <input type="url" name="instagram" form="profileUpdateForm"
                            ...
                            <div>
                                ...
                                <input type="url" name="linkedin" form="profileUpdateForm"
                            ...
                            <div>
                                ...
                                <input type="url" name="github" form="profileUpdateForm"
                            ...
                            <div>
                                ...
                                <input type="url" name="personal_link" form="profileUpdateForm"
                                    value="{{ old('personal_link', $user->profile->personal_link ?? '') }}"
