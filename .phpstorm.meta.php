...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./home/miky/Documents/Laravel/WebISC2/public/storage' => 'string',
...
'filesystems.disks.s3.report','filesystems.links./home/miky/Documents/Laravel/WebISC2/public/storage','logging.default','logging.deprecations.channel','logging.deprecations.trace',
...
'signed','throttle','verified','role',);
        registerArgumentsSet('routes', 'home','events.public','landing.events.show','landing.events.register',
'anggota','anggota.show','dosen','dokumen','landing.creation',
'landing.creation.detail','typing.index','blog.index','blog.show','password.request',
'password.email','password.reset','password.update','documents.download','login',
'login.post','register','register.post','waiting.verification','password.update',
'landing.forms.index','landing.forms.show','landing.forms.submit','typing.store','logout',
'dashboard','profile.edit','profile.update','projects.like','admin-events.index',
'admin-events.create','admin-events.store','admin-events.show','admin-events.edit','admin-events.update',
'admin-events.destroy','admin-events.registrants','events.my','myproject.index','projects.index',
'projects.create','projects.store','projects.show','projects.edit','projects.update',
'projects.destroy','comments.update','comments.destroy','posts.comment','admin.projects.all',
'admin.projects.index','admin.projects.verify','admin.projects.unverify','forms.responses','forms.index',
'forms.create','forms.store','forms.show','forms.edit','forms.update',
'forms.destroy','posts.manage','posts.create','posts.store','posts.edit',
'posts.update','posts.destroy','landing.index','landing.update','advisors.index',
'advisors.store','advisors.update','advisors.destroy','faq.index','faq.store',
'faq.update','faq.destroy','teams.index','teams.store','teams.update',
'teams.destroy','users.index','users.unverified','users.verify','users.update-role',
'users.destroy','regist.destroy','documents.index','documents.create','documents.store',
'documents.destroy','storage.local','storage.local.upload',);
        registerArgumentsSet('views', 
'admin.advisor.index','admin.faq.index','admin.landing.index','admin.projects.index','admin.projects.monitoring',
'admin.team.index','admin.users.index','admin.users.verify','auth.forgot-password','auth.login',
'auth.register','auth.reset-password','auth.waiting-verification','blog.blog','blog.blog-detail',
'creation.creation','creation.creation-detail','dashboard','emails.reset-password','events.create',
'events.edit','events.index','events.my-events','events.registrants','index',
'landing.about','landing.anggota','landing.anggota-detail','landing.blog','landing.creation',
'landing.dokumen','landing.dosen','landing.events','landing.events-detail','landing.faq',
'landing.footer','landing.forms.index','landing.forms.index-internal','landing.forms.show','landing.head',
'landing.hero','landing.master','landing.nav','landing.script','landing.team',
'landing.typing','landing.typing-leaderboard','landing.visi-misi','layouts.app','pagination::bootstrap-4',
'pagination::bootstrap-5','pagination::custom','pagination::default','pagination::semantic-ui','pagination::simple-bootstrap-4',
'pagination::simple-bootstrap-5','pagination::simple-default','pagination::simple-tailwind','pagination::tailwind','profile.edit',
'user.documents.create','user.documents.index','user.forms.create','user.forms.edit','user.forms.index',
'user.forms.responses','user.posts.create','user.posts.edit','user.posts.index','user.projects.form',
'user.projects.index','vendor.pagination.bootstrap-4','vendor.pagination.bootstrap-5','vendor.pagination.custom','vendor.pagination.default',
